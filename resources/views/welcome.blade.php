                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        data-toggle="modal" data-target="#editModal"onclick="{{$ecom->id}}">
                ...
                <!-- Edit Modal Form -->
                    <div class="row">
                        <div class="col-lg-12" id="edit_div">
                          @foreach ($ecomarr as $hi)
                            <form method="post" action="../update/{{$hi->id}}"  enctype="multipart/form-data" >
                              @csrf
                              
                  <div class="form-group">
                    <label > Category Name</label>
                    <input type="text" name="txt_category_name" class="form-control"  id="txt_category_name" 
                    placeholder="Name" value="{{$hi->category_name}}">
                  </div>
                  <div class="form-group">
                    <label > Category Description</label>
                    <input type="text" name="txt_category_des" class="form-control"  id="txt_category_des" 
                  placeholder="Description" value="{{$hi->category_des}}">
                  </div>
