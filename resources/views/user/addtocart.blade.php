            ...
            <table class="table table-bordered text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        ...
                        <td class="align-middle"><img src="{{url('user/img/product-5.jpg')}}" alt="" style="width: 50px;"> {{--$product->product_name--}}</td>
                        <td class="align-middle">{{--$product->product_price--}}120</td>
                        ...
                        <td class="align-middle">{{--$producr->product_price--}}120</td>
